...
function loadDashboard() {
    ...
    years.forEach((y, i) => {
        ...
        tastings.filter(t => t.date.startsWith(y)).forEach(t => {
            ...
            // NEU: Hier werden jetzt 4 Buttons generiert (Bearbeiten, Wertung, Excel, Löschen)
...
// NEU: Diese Funktion zeigt sofort die Auswertung eines Tastings, ohne den Editor zu öffnen
