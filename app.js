...
function openGlobalWhiskyEdit() {
    ...
    ['name', 'distillery', 'cask', 'finish', 'type', 'country', 'age', 'abv'].forEach(key => {
...
async function saveWhiskyFromModal() {
    ...
    let wData = {
        ...
        finish: document.getElementById('w-finish').value,
    ...
    // GEÄNDERT: Hier wird jetzt unterschieden, ob wir global oder in einem Tasting editieren
